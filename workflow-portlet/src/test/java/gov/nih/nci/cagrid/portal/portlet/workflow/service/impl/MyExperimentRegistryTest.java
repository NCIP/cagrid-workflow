...
import gov.nih.nci.cagrid.portal.portlet.workflow.WorkflowExecutionException;
...
public class MyExperimentRegistryTest {
	...
	@Test
	public void testJAXB() throws WorkflowExecutionException {
		...
		List<MyExperimentWorkflows.WorkflowStub> workflows = MyExperimentWorkflowRegistry.unmarshalWorkflows(new StringInputStream(xml)); 
	...
	@Test
	public void testGetWorkflows() throws WorkflowExecutionException {
		Map<String, WorkflowDescription> workflows = reg.getWorkflows();
		assertNotNull(workflows);
	}
	@Test
	public void testGetWorkflow() throws WorkflowExecutionException {
